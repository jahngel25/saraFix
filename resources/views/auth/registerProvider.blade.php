        ...
        <div class="col-md-8 col-md-offset-4">
            <div class="panel panel-default classTransparent">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}" id="register" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('type_user') ? ' has-error' : '' }}">
                            <label for="type_user" class="col-md-4 control-label">Tipo de registro</label>

                            <div class="col-md-6">
                                <select name="type_user" id="type_user" class="form-control" style="background: transparent; color: #fff" disabled>
                        ...
                        <input type="hidden" name="type_user" id="type_user" value="1">
                    </form>
                </div>
            </div>
        </div>
