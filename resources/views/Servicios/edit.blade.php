            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('actionEditServicio', $modelServicio->id) }}" files="true" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-4 control-label">Servicio</label>

                                <div class="col-md-6">
                                    <input id="name" type="text" class="stylesInput" name="name" value="{{$modelServicio->name}}" required autofocus>
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text" class="stylesInput" name="description" value="{{$modelServicio->description}}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('img') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="img" type="file" class="stylesInput" name="img" value="{{$modelServicio->img}}" autofocus>
                            ...
                            <div class="form-group{{ $errors->has('precio') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="precio" type="text" class="stylesInput" name="precio" value="{{$modelServicio->precio}}" required autofocus>
