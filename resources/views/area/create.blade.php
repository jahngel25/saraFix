        ...
        <div class="row">
           <div class="col-md-12">
               <div class="panel panel-default">
                   <div class="panel-heading">Reguistrar Area</div>
                   <div class="panel-body">
                       <form class="form-horizontal" method="POST" action="{{ route('crearArea') }}" files="true" enctype="multipart/form-data">
                           {{ csrf_field() }}
                           ...
                           <div class="form-group{{ $errors->has('texto') ? ' has-error' : '' }}">
                               ...
                               <div class="col-md-6">
                                   <input id="texto" type="text" class="stylesInput" name="texto" value="{{ old('texto') }}" required autofocus>
                           ...
                           <div class="form-group{{ $errors->has('img_inter') ? ' has-error' : '' }}">
                               ...
                               <div class="col-md-6">
                                   <input id="img_inter" type="file" class="stylesInput" name="img_inter" value="{{ old('img_inter') }}" required autofocus>
