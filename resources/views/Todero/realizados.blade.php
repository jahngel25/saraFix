...
@section('content')
    <div class="container" style="margin-top: 3%">
        <h3 align="center">Trabajos terminados</h3>
        <br>
                            ...
                            <div class="row" style="padding: 3%">
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-3 text-center" style="padding-top: 2%;" onclick="calificar({{$value->id}})">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title textAlingCenter" id="exampleModalLabel">Calificacion cliente</h3>
                </div>
                <div class="modal-body">
                    <form action="{{route('calificarCliente')}}" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
